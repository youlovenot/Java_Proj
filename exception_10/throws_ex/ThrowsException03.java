...
public class ThrowsException03 {	//throws: 예외를 미루는것, 호출하는 곳에서 예외 처리를 해야함
	...
	public static void main(String[] args) {
		...
		ThrowsException03 test = new ThrowsException03();	//thows Exception을 처리는객체 생성
...
*/		
		...
		} catch (Exception e) {	//그 외의 모든 Exception을 처리한다. << 최상위의 Exception >>
			System.out.println(e);
		}
